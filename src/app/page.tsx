    ...
    <main className="grid min-h-screen place-items-center px-6 py-16 sm:px-12">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-balance text-base md:text-lg">
          Dapp Auth Template provides a clean, extensible starting point for EVM dapps.
          Includes ready-made login methods (Google, GitHub, Email, Wallet), protected routes,
          and a modern UI powered by privy.
        </p>
